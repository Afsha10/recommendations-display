...
INSERT INTO entries(medium_id, title)
    ...
    (4, 'Picasso at Tate Modern'),
   	...
   	(2, 'Interstellar'),
   	(1, 'Lord Of The Rings'),
   	(2, 'Lord Of The R-- Storing different types of media (books, movies, music, events) in a separate table. This table is essential for categorizing recommendations.
...
INSERT INTO moods_entries (mood_id, entry_id)
   ...
   select  * from moods_entries;ings');
...
-- This table establishes the association between recommendations and the people who make them. 
